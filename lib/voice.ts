...
export function isVoiceSupported(): boolean {
  ...
  return typeof window !== 'undefined' && 'speechSynthesis' in window && 'SpeechRecognition' in window;
}
...
export function getVoiceLang(lang: string): string {
  return LANG_VOICE_MAP[lang] || 'en-US';
}
